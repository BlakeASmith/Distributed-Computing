...
func TestReElection2A(t *testing.T) {
	...
	log.Println("META: disconnect leader 1")
	...
	log.Println("META: disconnect two leaders")
	...
	log.Println("META: reconnect a leader")
	// if a quorum arises, it should elect a leader.
	cfg.connect((leader2 + 1) % servers)
	cfg.checkOneLeader()

	log.Println("META: reconnect the last leader")
